...
insert into users values (6,'Mrs. Dennis Schulist', 'Leopoldo_Corkery', 'Karley_Dach@jasper.info'); 
insert into users values (7,'Kurtis Weissnat','Elwyn.Skiles','Telly.Hoeger@billy.biz');
insert into users values (8,'Nicholas Runolfsdottir V', 'Maxime_Nienow', 'Sherwood@rosamond.me'); 
insert into users values (9,'Glenna Reichert','Delphine','Chaim_McDermott@dana.io');
insert into users values (10,'Clementina DuBuque', 'Moriah.Stanton', 'Rey.Padberg@karina.biz');